...
function App(){
  ...
  <section className="toolbar"><label>Map seed <input value={seed} onChange={e=>setSeed(e.target.value)}/></label><button disabled={busy} onClick={generate}>{busy?'Calculating…':'Generate study'}</button><a href="/">City battle ↗</a></section>
