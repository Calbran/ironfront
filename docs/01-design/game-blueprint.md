...
**Provisional:** 28 days; 16–64 territories per continent in the current proof; three factions; 3–6 armies per nation in the full game; hourly simulation; 12–24-hour meaningful offensives. All numbers need testing.
...
**New accepted direction:** individually commanded squads/units with optional group orders, fewer territories and local positions. The current army implementation below remains shipped behavior until that transition is designed and built. See [decision 007](../05-decisions/007-territory-features.md).
